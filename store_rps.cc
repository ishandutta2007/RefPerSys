...
private:
  ...
  void write_generated_roots_c_file(void);
  void write_generated_names_file(void);
  void write_generated_names_c_file(void);
  void write_generated_constants_file(void);
  void write_generated_constants_c_file(void);
...
void
Rps_Dumper::write_generated_roots_c_file(void)
{
  std::lock_guard<std::recursive_mutex> gu(du_mtx);
  RPS_DEBUG_LOG(DUMP, "dumper write_generated_roots_file start");
  auto rootpathstr = std::string{"generated/rpsc-roots.h"};
  auto pouts = open_output_file(rootpathstr);
  rps_emit_gplv3_copyright_notice(*pouts, rootpathstr, "//: ", "");
  *pouts << std::endl << "// generated by " << __FILE__ ":" << __LINE__ << std::endl;
  *pouts << std::endl
  ...
  *pouts << "/// end of RefPerSys C roots file " << rootpathstr << std::endl;
  RPS_DEBUG_LOG(DUMP, "dumper write_generated_roots_file end rootcnt=" << rootcnt << std::endl);
} // end Rps_Dumper::write_generated_roots_c_file
...
Rps_Dumper::write_generated_names_file(void)
{
  ...
  *pouts << "/// end of RefPerSys names file " << rootpathstr << std::endl;
...
void
Rps_Dumper::write_generated_names_c_file(void)
{
  std::lock_guard<std::recursive_mutex> gu(du_mtx);
  auto rootpathstr = std::string{"generated/rpsc-names.h"};
  RPS_DEBUG_LOG(DUMP, "dumper write_generated_names_file start");
  auto pouts = open_output_file(rootpathstr);
  rps_emit_gplv3_copyright_notice(*pouts, rootpathstr, "//: ", "");
  *pouts << std::endl << "/// generated from " << __FILE__ ":" << __LINE__ << std::endl;
  *pouts << std::endl
         << "#ifndef RPS_INSTALL_NAMED_ROOT_OB" << std::endl
         << "#error RPS_INSTALL_NAMED_ROOT_OB(Oid,Name) macro undefined" << std::endl
         << "#endif /*undefined RPS_INSTALL_NAMED_ROOT_OB*/" << std::endl << std::endl;
  ...
  *pouts << std::endl
         << "#undef RPS_INSTALL_NAMED_ROOT_OB" << std::endl;
  *pouts << "/// end of RefPerSys C names file " << rootpathstr << std::endl;
  RPS_DEBUG_LOG(DUMP, "dumper write_generated_names_file end namecnt=" << namecnt << std::endl);

} // end Rps_Dumper::write_generated_names_c_file
...
void
Rps_Dumper::write_generated_constants_c_file(void)
{
  std::lock_guard<std::recursive_mutex> gu(du_mtx);
  auto rootpathstr = std::string{"generated/rpsc-constants.h"};
  RPS_DEBUG_LOG(DUMP, "dumper write_generated_constants_file start");
  auto pouts = open_output_file(rootpathstr);
  rps_emit_gplv3_copyright_notice(*pouts, rootpathstr, "//: ", "");
  unsigned constcnt = 0;
  *pouts << std::endl << "/// collection of constant objects, mentioned in generated C files, "<< std::endl
         << "/// .... prefixed with '"
         <<  RPS_CONSTANTOBJ_PREFIX << "' followed by an oid." << std::endl;
  *pouts << "/// generated from " << __FILE__ ":" << __LINE__ << std::endl;
  *pouts << std::endl
         << "#ifndef RPS_INSTALL_CONSTANT_OB" << std::endl
         << "#error RPS_INSTALL_CONSTANT_OB(Oid) macro undefined" << std::endl
         << "#endif /*undefined RPS_INSTALL_CONSTANT_OB*/" << std::endl << std::endl;
  ...
  *pouts << std::endl
         << "#undef  RPS_NB_CONSTANT_OB" << std::endl
         << "#define RPS_NB_CONSTANT_OB " << constcnt << std::endl << std::endl;
  *pouts << "/// end of RefPerSys C constants file " << rootpathstr << std::endl;
  RPS_DEBUG_LOG(DUMP, "dumper write_generated_constants_c_file end constcnt=" << constcnt << std::endl);
} // end Rps_Dumper::write_generated_constants_c_file
...
Rps_Dumper::write_all_generated_files(void)
{
  ...
  write_generated_roots_c_file();
  write_generated_names_file();
  write_generated_names_c_file();
  write_generated_constants_file();
  write_generated_constants_c_file();
